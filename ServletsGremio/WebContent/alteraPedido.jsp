...
<body>
	...
	<section class="container center">
		...
		<h2 class="title">Pedido</h2>
			<form action="PedidoControle" method="GET" class="frm">
					<input type="hidden" id="opcao" name="opcao" value="update" /><br>
					<input type="hidden" id="id" name="id"value="<%=request.getParameter("id")%>" />
					
					<div class="form-group">
						<label for="prod">Produto:</label> 					
						<select id="prod" name="prod" required>
							<option value="1">Camisa Tricolor Masc. I 2016</option>
							<option value="2">Camisa Penta Campeão Rei de Copas</option>
							<option value="3">Camisa Umbro Grêmio Retrô</option>
							<option value="4">Camisa Tricolor Masc. I 2017</option>
						</select>
					</div>
